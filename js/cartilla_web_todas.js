jQuery(document).ready(function($){
	...
	var agreement_id = $('#convenios').val()
	...
	$('#convenios').on('change', function(){
		...
		console.log( $('#convenios').val() )
		
		var agreement_id = $('#convenios').val().split(',')[0]
		var plan_id = $('#convenios').val().split(',')[1]		
		
//		console.log(agreement_id.split(',')[0])
