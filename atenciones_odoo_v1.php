...
<nav id="atenciones_odoo" style="display: none">
	...
	<div id="agregar_atencion">
		<form id="frm_afiliado" name="frm_afiliado" method="post" enctype="multipart/form-data" action=""
			...
			<p>Archivos Permitidos: <strong>.jpg</strong> / <strong>.jpeg</strong> / <strong>.gif</strong> /
				<strong>.png</strong> / <strong>.pdf</strong> / <strong>.doc</strong> / <strong>.docx</strong> /
				<strong>.xls</strong> / <strong>.xlsx</strong> / <strong>.tif</strong> / <strong>.tiff</strong></p>
